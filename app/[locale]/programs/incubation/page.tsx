...
import { ArrowRight, Banknote, Clock, Building2 } from "lucide-react";
...
export const metadata: Metadata = {
  ...
  description: "Full-stack incubation at IC IITP — MeitY, SISF, BioNEST, iDEX, and more. Seed funding, lab access, and mentoring for deep-tech startups.",
};
...
export default async function IncubationPage({ params }: Props) {
  ...
  const category = PROGRAM_CATEGORIES[1];
  const programs = await getProgramsBySection("INCUBATION").catch(() => []);
    ...
    <>
      <div className="relative overflow-hidden" style={{ background: "linear-gradient(160deg, var(--color-hero-from) 0%, var(--color-hero-via) 60%, var(--color-hero-to) 100%)" }}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-28 pb-20 relative z-10">
          <Breadcrumb items={[{ label: "Home", href: "/" }, { label: "Programs", href: "/programs" }, { label: "Incubation" }]} variant="light" />
